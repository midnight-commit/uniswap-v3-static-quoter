...
import "./interfaces/IPharStaticQuoter.sol";
import "./interfaces/IClPoolFactory.sol";

import "./PharQuoterCore.sol";

import "hardhat/console.sol";

contract PharStaticQuoter is IPharStaticQuoter, PharQuoterCore {
    ...
    function getPool(address tokenA, address tokenB, uint24 fee) private view returns (IUniswapV3Pool) {
        ...
        return IUniswapV3Pool(IClPoolFactory(factory).getPool(tokenA, tokenB, int24(fee)));
    }
